...
namespace RottenBamboo {
    ...
    RBSkyPass::RBSkyPass(int colorAttachmentCount, bool bResolveAttachment, bool bDephAttament, RBDevice &device, RBDescriptors<TEXTURE_CUBEMAP_COUNT, 1> &descriptors, const RBPipelineConfig &config, VkImageLayout layout)
    ...
    void RBSkyPass::recordCommandBuffer(VkCommandBuffer commandBuffer, VkRenderPassBeginInfo renderPassInfo, RBDescriptors<TEXTURE_CUBEMAP_COUNT, 1>& descriptors, RBMesh &mesh) 
    {
