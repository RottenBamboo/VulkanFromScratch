...
namespace RottenBamboo {
    ...
    RBLightingPass::RBLightingPass(int colorAttachmentCount, bool bResolveAttachment, bool bDephAttament, RBDevice &device, RBDescriptors<1, 1> &descriptors, const RBPipelineConfig &config)
