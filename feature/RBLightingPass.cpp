...
namespace RottenBamboo {
    ...
    RBLightingPass::RBLightingPass(int colorAttachmentCount, bool bResolveAttachment, RBDevice &device, RBDescriptors<1, 1> &descriptors, const RBPipelineConfig &config)
