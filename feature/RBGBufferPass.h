...
namespace RottenBamboo {
    ...
    public:
        ...
        RBGBufferPass(int colorAttachmentCount, bool bResolveAttachment, RBDevice &device, RBDescriptors<TEXTURE_PATHS_MECH_COUNT, 1> &descriptors, const RBPipelineConfig &config);
