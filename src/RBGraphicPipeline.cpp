...
namespace RottenBamboo {
    ...
    void RBGraphicPipeline::createGraphicsPipeline() {
        ...
        pipelineLayoutInfo.pSetLayouts = &rbDescriptors.descriptorSetLayout;
    ...
    RBGraphicPipeline::~RBGraphicPipeline() {
        ...
        vkDestroyDescriptorSetLayout(rbSwapChain.refDevice.device, rbDescriptors.descriptorSetLayout, nullptr);
    }
}
