...
namespace RottenBamboo {
    ...
    void RBGraphicPipeline::createGraphicsPipeline() {
        ...
        pipelineLayoutInfo.pSetLayouts = &rbDescriptors.descriptorSetLayoutManager.descriptorSetLayout;
    ...
    RBGraphicPipeline::~RBGraphicPipeline() {
        ...
        vkDestroyDescriptorSetLayout(rbSwapChain.refDevice.device, rbDescriptors.descriptorSetLayoutManager.descriptorSetLayout, nullptr);
    }
}
