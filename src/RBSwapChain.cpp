...
namespace RottenBamboo{
    ...
    uint32_t RBSwapChain::findMemoryType(VkPhysicalDevice* physicalDevice, uint32_t typeFilter, VkMemoryPropertyFlags properties)
    {
    ...
    RBSwapChain::SwapChainSupportDetails RBSwapChain::querySwapChainSupport(VkPhysicalDevice& device, VkSurfaceKHR& surface)
    {
    ...
    VkExtent2D chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabalities, GLFWwindow* window)
    {
