...
namespace RottenBamboo {
    ...
    public:
        ...
        std::array<VkFormat, TEXTURE_PATHS_MECH_GBUFFER_OUTPUT_COUNT> lightingImageFormats{VK_FORMAT_R16G16B16A16_SFLOAT, VK_FORMAT_R16G16B16A16_SFLOAT, VK_FORMAT_R16G16B16A16_SFLOAT, VK_FORMAT_R16G16B16A16_SFLOAT, VK_FORMAT_D32_SFLOAT};
        ...
        RBDescriptors<TEXTURE_PATHS_SKYBOX_COUNT, 1> descriptorsSkyBox{device, commandBuffer, uniformBuffers, TEXTURE_PATHS_SKYBOX, false};
